...
#
class corp104_rabbitmq_exporter::service (
  String    $rabbit_url               = $corp104_rabbitmq_exporter::rabbit_url,
  String    $rabbit_user              = $corp104_rabbitmq_exporter::rabbit_user,
  String    $rabbit_password          = $corp104_rabbitmq_exporter::rabbit_password,
  String    $queues_include_regex     = $corp104_rabbitmq_exporter::queues_include_regex,
  String    $queues_exclude_regex     = $corp104_rabbitmq_exporter::queues_exclude_regex,
  String    $vhosts_include_regex     = $corp104_rabbitmq_exporter::vhosts_include_regex,
  String    $vhosts_exclude_regex     = $corp104_rabbitmq_exporter::vhosts_exclude_regex,
  Array[String] $rabbit_capabilities  = $corp104_rabbitmq_exporter::rabbit_capabilities,
  Array[String] $rabbit_exporters     = $corp104_rabbitmq_exporter::rabbit_exporters,
